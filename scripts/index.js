...
const Twitch = new Plataforma("Twitch TV", "https://es.wikipedia.org/wiki/Twitch#/media/Archivo:Twitch.jpg", "Es una plataforma estadounidense perteneciente a la empresa Amazon, Inc., que permite realizar transmisiones en vivo.", Amazon);
...
const TWP = new Canal("The Wild Project", "https://yt3.googleusercontent.com/ytc/AGIKgqPt-8adQY7673XTElkb-bYKWeUfGGmsKVd7OTTt1Q=s900-c-k-c0x00ffffff-no-rj", "es un podcast de vídeo y audio conducido por Jordi Wild, youtuber de éxito con más de 11 millones de suscriptores en YouTube y un alcance de más de mil millones de visualizaciones.", Twitch, JW);
